...
$selectedAY = $_GET['ay'] ?? 'all';

$ayFilter = '';
if ($selectedAY !== 'all') {
    [$startYear, $endYear] = explode('-', $selectedAY);
    $ayFilter = "
        WHERE upload_date >= '$startYear-06-01'
          AND upload_date <  '$endYear-06-01'
    ";
}
...
<form method="GET" class="filter-bar">
  ...
  <select name="ay" onchange="this.form.submit()">
    ...
    for ($y = $currentYear; $y >= $currentYear - 2; $y--) {
        $ay = "$y-" . ($y + 1);
        $selected = ($selectedAY === $ay) ? 'selected' : '';
...
<section class="report-box">
  <h2 class="report-title"><i class="fas fa-file-alt"></i> Document Reports</h2>
...
=========================== -->
<section class="report-box">
  <h2 class="report-title"><i class="fas fa-users"></i> Account Reports</h2>
